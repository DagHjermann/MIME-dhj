...
df2 %>%
  ...
  labs(title = paste0(param, " at ", station, ", dry wt by year"))
...
df2 %>%
  ...
  geom_point() +
  geom_smooth(method = "lm", formula = 'y ~ x') +
  labs(title = paste0(param, " at ", station, ", Fultons by year"))
...
ggplot(df2_sel, aes(year, DRYWT)) +
  geom_point() +
  geom_smooth(method = "lm", formula = 'y ~ x') +
  labs(title = paste0(param, " at ", station, " (", df2_sel$country[1], "), dry wt"))

ggplot(df2_sel, aes(year, Fultons)) +
  geom_point() +
  geom_smooth(method = "lm", formula = 'y ~ x') +
  labs(title = paste0(param, " at ", station, " (", df2_sel$country[1], "), Fulton"))
