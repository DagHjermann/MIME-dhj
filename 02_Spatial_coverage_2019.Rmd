...
gg <- df_sed_10km %>%
  ...
  coord_quickmap() +
  theme_void() +
  labs(title = "Sediment (10 km squares)")

ggsave("Figures/02_Sediment_map_squares.png", gg, width = 10, height = 7)
...
gg <- ggplot(df_bio_all, aes(x = detGroup, y = n, fill = Type)) +
  geom_col(color = "black", size = 0.2) +
  scale_fill_manual(values = c("pink", "green", "blue3")) +
  facet_wrap(vars(region)) +
  theme(axis.text.x = element_text(hjust = 0, angle = -45)) + 
  labs(title = "Sediment (number of 10 km squares)", y = "Number of 10 km squares")
  
ggsave("Figures/02_Sediment_no_squares.png", gg, width = 10, height = 7)
...
gg <- df_bio_10km %>%
  ...
  coord_quickmap() +
  theme_void() +
  labs(title = "Biota (10 km squares)")

ggsave("Figures/02_Biota_map_squares.png", gg, width = 7, height = 7)
...
gg <- ggplot(df_bio_all, aes(x = detGroup, y = n, fill = Type)) +
  ...
  facet_wrap(vars(region)) +
  theme(axis.text.x = element_text(hjust = 0, angle = -45)) + 
  labs(title = "Biota (number of 10 km squares)", y = "Number of 10 km squares")
  
ggsave("Figures/02_Biota_no_squares.png", gg, width = 10, height = 7)
